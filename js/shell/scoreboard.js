import { careerTotals, poolSizes, topScores } from "../shared/history.js";
import { effectiveLength } from "../shared/pool.js";
import { summarizeSelection } from "../shared/regions.js";
import { formatElapsed, PLAYABLE_MODES, runHasProgress } from "../shared/run.js";
...
function renderGameBoard(root, state, mode) {
  ...
  const currentSize = effectiveLength(state.roundN, state.selectedNames.size);
